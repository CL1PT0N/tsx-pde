import { Box, Image, VStack, Text, HStack, IconButton } from '@chakra-ui/react';
import { Edit2, Trash2 } from 'react-feather';
import React from 'react';
import EditButton from './EditButton';
import DeleteButton from './DeleteButton';

export default function EDCard({ name, price, imageUrl, description, status, reload, productId }: any) {
  const EditProps = {
    name:name,
    price:price,
